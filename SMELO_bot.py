...
def ask_deepseek(character_key, problem_text, username):
    ...
    system_prompt = (
        ...
        f"Максимальная длина — 120 слов. Формулируй всё так, чтобы слова не обрезались, а мысли были законченными."
    )
...
Ответ должен быть добрым, поддерживающим и вдохновляющим. Максимум 250 слов. Формулируй всё так, чтобы слова не обрезались, а мысли были законченными.
"""
